...
|formatter|String|false||Id of formatter which will format object to String. It must be consistend with value of pl.fhframework.formatter.FhFormatter annotation.|
...
|label|ModelBinding|true||Component label. Supports FHML - FH Markup Language.|
...
|value|ModelBinding|false||Represents text value for created component.|
