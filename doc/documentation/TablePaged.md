...
|defaultSortBy|String|false||Property name by default passed in the Pageable object to be interpreted in a data source (eg. DAO)|
|defaultSortByAsc|boolean|false|true|If defaultSortBy is set this property decides if default order is ascending|
...
|onPageChange|ActionBinding|false|-|If the table page is changed that method will be executed|
|onPageSizeChange|ActionBinding|false|-|If the table page size is changed that method will be executed|
...
|onSortChange|ActionBinding|false|-|If the table page sorting is changed that method will be executed|
...
|pageSize|int|false||Amount of records displayed on single page|
