...
public class DictionaryComboFhDP_OLD extends ComboFhDP implements IGroupingComponent<DictionaryComboParameterFhDP> {
    ...
    public DictionaryComboFhDP_OLD(Form form) {
        super(form);
    }
