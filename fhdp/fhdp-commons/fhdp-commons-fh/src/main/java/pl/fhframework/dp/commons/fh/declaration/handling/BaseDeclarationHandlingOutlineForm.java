...
public abstract class BaseDeclarationHandlingOutlineForm<T extends BaseDeclarationHandlingFormModel> extends Form<T> {
    String outlineMainName = "outlineMain";
    String outlineMessagesName = "messages";

    /**
     * Previous implementation:
     * !getModel().getSpecificDeclarationFormModel().isHasTabs()
     */
    ...
    public void selectLeftMenuElementByLabel(String elementLabel){
        TreeFhDP tree = (TreeFhDP) getFormElement("declarationLeftMenuTreeRoot");
