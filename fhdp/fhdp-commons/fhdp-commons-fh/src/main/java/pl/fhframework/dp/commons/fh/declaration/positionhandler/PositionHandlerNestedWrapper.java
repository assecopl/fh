 ...
 */
@Builder
public class PositionHandlerNestedWrapper<POSITION extends Serializable, MODEL extends BaseDeclarationFormModel> implements IPositionHandlerBase<MODEL, POSITION> {
