...
<!--        <Invisible when="translationNO==false">noLang</Invisible>-->
    ...
    <Row styleClasses="flex-nowrap">
        <Dropdown width="md-2" label="{language}"
                  ...
                  id="languageDropdown" hint="{$.menu.ui.navbar.toogleLanguage}">
            <DropdownItem value="{$.menu.ui.navbar.buttons.english}" icon="fas fa-globe-europe" id="englishLang" onClick="setLanguageEnglish" />
            <DropdownItem value="{$.menu.ui.navbar.buttons.lithuanian}" icon="fas fa-globe-europe" id="lithuanianLang" onClick="setLanguageLithuanian" />
            <DropdownItem value="{$.menu.ui.navbar.buttons.polish}" icon="fas fa-globe-europe" id="polishLang" onClick="setLanguagePolish" />
<!--            <DropdownItem value="{$.menu.ui.navbar.buttons.no_lang}" icon="fas fa-globe-europe" id="noLang" onClick="setLanguageNo" />-->
        ...
        <Button width="md-2" label="[icon='fas fa-question-circle']" hintTrigger="HOVER"
                ...
                id="helpSider"  hint="{$.menu.ui.navbar.help}"/>
        ...
        <Button id="diLogout" width="md-2" hintTrigger="HOVER"
                hint="{$.menu.ui.navbar.buttons.logout}"
                styleClasses="tray-button button"
