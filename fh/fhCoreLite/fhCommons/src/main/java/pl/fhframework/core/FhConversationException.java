...
/**
 * FhConversationException class. Thrown when there is an error with during conversation in persistence engine.
 * FhConversationException is direct subclass of a FhException.
 */
...
public class FhConversationException extends FhException {
    ...
    /**
     * Constructs a new fh conversation exception with {@code null} as its
    ...
    /**
     * Constructs a new fh conversation exception with the specified detail message.
     ...
     *                method.
     */
    @DocumentedConstructor (description = "Constructs a new fh conversation exception with the specified detail message. The cause is not initialized, and may subsequently be initialized by a call to <tt><b>initCause</b></tt>.",
    ...
    public FhConversationException(String message) {
        super(message);
    }

    /**
     * Constructs a new fh conversation exception with the specified detail message and
     ...
     */
    @DocumentedConstructor (description = "Constructs a new fh conversation exception with the specified detail message and cause.  <p>Note that the detail message associated with <tt><b>cause</b></tt> is <i>not</i> automatically incorporated in this runtime exception's detail message.",
    ...
    public FhConversationException(String message, Throwable cause) {
        super(message, cause);
    }

    /**
     * Constructs a new fh conversation exception with the specified cause and a
     ...
     */
    @DocumentedConstructor (description = "Constructs a new fh conversation exception with the specified cause and a detail message of  <tt>(cause==null ? null : cause.toString())</tt> (which typically contains the class and detail message of cause).  This constructor is useful for runtime exceptions that are little more than wrappers for other throwables.",
    ...
    public FhConversationException(Throwable cause) {
        super(cause);
    }
}
