...
/**
 * FhExternalServiceException class. Thrown when there is an runtime error within a UseCase or Rule. FhUseCaseException is direct subclass of a FhException.
 */
@DocumentedClass (description = "FhExternalServiceException class. Thrown when there is an runtime error within a UseCase or Rule. FhExternalServiceException is direct subclass of a FhException.")
public class FhExternalServiceException extends FhMessageException {
    /**
    ...
    public FhExternalServiceException(String message) {
        super(message);
    }
    ...
    public FhExternalServiceException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public FhExternalServiceException(Throwable cause) {
        super(cause);
    }
}
