...
/**
 * FhUseCaseException class. Thrown when there is an error with processing a UseCase, for example missing UseCase,
 * UseCase misses method to handle given action. FhUseCaseException is direct subclass of a FhException.
 */
@DocumentedClass (description = "FhUseCaseException class. Thrown when there is an error with processing a UseCase, for example missing UseCase, UseCase misses method to handle given action. FhUseCaseException is direct subclass of a FhException.")
public class FhUseCaseException extends FhException {
    ...
    public FhUseCaseException(String message) {
        super(message);
    }
    ...
    public FhUseCaseException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public FhUseCaseException(Throwable cause) {
        super(cause);
    }
}
