...
@DocumentedComponent(value = "Button component responsible for the grouping of RowDropdownItems in a table row.", icon = "fa fa-caret-square-down")
public class RowDropdown extends Dropdown implements Boundable, Styleable, IHasBoundableLabel, CompactLayout, IDesignerEventListener {
    ...
    private RowDropdownItem createExampleDropdownItem(int nameSuffix) {
        RowDropdownItem tab = new RowDropdownItem(getForm());
