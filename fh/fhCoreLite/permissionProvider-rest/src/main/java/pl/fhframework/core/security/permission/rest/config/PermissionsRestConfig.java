package pl.fhframework.core.security.permission.rest.config;
...
public class PermissionsRestConfig {
    ...
    @Value("${fhframework.security.permission.rest.templateType:Simple}")
    private RestTemplateType templateType;
    @Value("${fhframework.security.permission.rest.username:}")
    private String username;
    @Value("${fhframework.security.permission.rest.password:}")
    private String password;
    @Value("${fhframework.security.permission.rest.tokenUri:}")
    private String tokenUri;
    @Value("${fhframework.security.permission.rest.clientId:}")
    private String clientId;
    @Value("${fhframework.security.permission.rest.clientSecret:}")
    private String clientSecret;
    @Value("${fhframework.security.permission.rest.grantType:client_credentials}")
    private String grantType;
    @Value("${fhframework.security.permission.rest.scope:}")
