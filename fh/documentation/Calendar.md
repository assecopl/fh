...
|blockedDates|ModelBinding|true||Collection of dates blocked for selection.|
|changeMonth|ModelBinding|true|false|User can define if calendar displays menu for month selection.|
|changeYear|ModelBinding|true|false|User can define if calendar displays menu for year selection.|
...
|maxDate|ModelBinding|true||Maximum date for allowed selection.|
|minDate|ModelBinding|true||Minimum date for allowed selection.|
