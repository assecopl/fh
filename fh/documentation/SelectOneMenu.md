...
|displayExpression|String|false||Defines an attribute of a single value object to be used for display. If not set, converter will be used.|
|emptyLabel|boolean|false|false|Determines if empty value should be displayed on list of options.|
|emptyLabelText|String|false||Determines empty value text displayed on list of options.|
...
|keepRemovedValue|boolean|false|false|Determines if selected value that has been removed from values collection should still be present in control.|
