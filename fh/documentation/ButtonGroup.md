## Kontrolka ButtonGroup

| <center>Identifier </center>  |  <center>Type  </center> | <center> Boundable  </center> |  <center>DefaultValue </center>  |  <center>Description  </center>    |  
|-----------|------|-----------|--------------|----------------|
|activeButton|ModelBinding|true||Index of active Button. Default value of active button is -1, that means ButtonGroup does not have active button by default.|
...
|margin|boolean|false|false|Flag decides if margin should be displayed or not.|
...
|onButtonChange|ActionBinding|false||If there is some value, representing method in use case, then on clicking on button, that method will be executed. This method fires, when button is clicked.|
