...
|-----------|------|-----------|--------------|----------------|
|active|ModelBinding|true|true|Flag which defines if the timer is active.|
...
|interval|ModelBinding|true||Time in seconds between subsequent times runs.|
...
|onTimer|ActionBinding|false||If the timer runs that method will be executed.|
