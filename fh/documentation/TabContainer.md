## Kontrolka TabContainer

| <center>Identifier </center>  |  <center>Type  </center> | <center> Boundable  </center> |  <center>DefaultValue </center>  |  <center>Description  </center>    |  
|-----------|------|-----------|--------------|----------------|
|activeTabId|ModelBinding|true||Represents the identification of the active tab|
|activeTabIndex|ModelBinding|true|0|Represents the index of the active tab|
...
|onTabChange|ActionBinding|false||If there is some value, representing method in use case, then on clicking on tab, that method will be executed. This method fires, when component loses focus. Warning!!if possible for component, use onInput!!|
