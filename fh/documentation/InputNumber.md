...
|maxFractionDigits|Integer|false||Defines how many fraction digits can be used.|
|maxIntigerDigits|Integer|false||Defines how many integer digits can be used.|
