...
|imageAreas|String|false||Component area parameter containing id and coordinates|
...
|onAreaClick|ActionBinding|false||If the image area is clicked that method will be executed. Action is fired, while component is active.|
|onClick|ActionBinding|false||If the image is clicked that method will be executed. Action is fired, while component is active.|
...
|src|ModelBinding|true||Component source|
