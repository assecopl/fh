...
|-----------|------|-----------|--------------|----------------|
|activeGroup|ModelBinding|true|0|Index of uncollapsed tab.|
...
|onGroupChange|ActionBinding|false||If there is some value, representing method in use case, then on clicking on group, that method will be executed. This method fires, when group will be opened.|
