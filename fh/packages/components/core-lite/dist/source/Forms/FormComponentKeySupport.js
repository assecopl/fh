...
var FormComponentKeySupport = /** @class */ (function () {
    function FormComponentKeySupport(componentObj, formElement) {
        this.modifiers_map = {
            'CTRL': 100000,
            'ALT': 10000,
            'SHIFT': 1000
        };
        this.special_keys_map = {
            'F1': 112,
            'F2': 113,
            'F3': 114,
            'F4': 115,
     ...
     */
    FormComponentKeySupport.prototype.addKeyEventListeners = function (input, requiredEventSource) {
        if (requiredEventSource === void 0) { requiredEventSource = undefined; }
        if (this.keyToHandlerMap != null) {
            var keydownListener = function (event) {
                ...
                .bind(this);
            var keyupBlurListener = function (event) {
    ...
    FormComponentKeySupport.prototype.supportsKey = function (event) {
        return this.findSupportedKeyHandler(event) != null;
    };
    FormComponentKeySupport.prototype.findSupportedKeyHandler = function (event) {
        return this.keyToHandlerMap[this.transformKeyEvent(event)];
    };
    FormComponentKeySupport.prototype.createKeyToHandlerMap = function (componentObj) {
    ...
    FormComponentKeySupport.prototype.transformKeyDefinition = function (definition) {
    ...
    FormComponentKeySupport.prototype.transformKeyEvent = function (event) {
        var definitionInt = 0;
        var code = 0;
    ...
    return FormComponentKeySupport;
}());
exports.FormComponentKeySupport = FormComponentKeySupport;
//# sourceMappingURL=FormComponentKeySupport.js.map