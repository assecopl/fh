...
var autosize = require("../../external/autosize.min.js");
var InputText = /** @class */ (function (_super) {
    ...
    function InputText(componentObj, parent) {
        ...
        _this.isTextarea = (_this.componentObj.rowsCount && _this.componentObj.rowsCount > 0) || _this.componentObj.rowsCountAuto;
        _this.textareaAutosize = _this.componentObj.rowsCountAuto || false;
    ...
    InputText.prototype.getMainComponent = function () {
    ...
    InputText.prototype.handleContainerOverflow = function (parent, autocompleter, up) {
