...
var SelectComboMenu = /** @class */ (function (_super) {
    ...
    SelectComboMenu.prototype.getInputDebounceTime = function () {
        return 200;
    };
        ...
        if (keyCode === 9 || keyCode === 13) {
            ...
            if ((keyCode === 40 || keyCode === 38) && !this.autocompleter.classList.contains('isEmpty')) {
                ...
                if (this.autocompleteOpen) {
                    ...
                    if (current) {
                        this.input.value = current.displayAsTarget ? current.targetValue : current.displayedValue;
                        ;
    ...
    SelectComboMenu.prototype.openAutocomplete = function () {
        ...
        var parent = null;
        var sumHeight = bounding.height + this.inputGroupElement.offsetHeight + 30; //Height of autocompleter and input.
        if (formType === 'STANDARD') {
            ...
            if (parent.hasClass('hasHeight')) {
                ...
                var biggerThenParent = (parentBound.height <= sumHeight);
