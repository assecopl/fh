...
var SelectComboMenuOptimized = /** @class */ (function (_super) {
    ...
    SelectComboMenuOptimized.prototype.innerWrap = function () {
        return this.input;
    };
    SelectComboMenuOptimized.prototype.defineDefinitionSymbols = function () {
        _super.prototype.defineDefinitionSymbols.call(this);
    };
    SelectComboMenuOptimized.prototype.createOpenButton = function () {
    ...
    SelectComboMenuOptimized.prototype.inputPasteEvent = function (event) {
    ...
    SelectComboMenuOptimized.prototype.inputInputEvent = function () {
        this.selectedIndex = null;
        this.updateModel();
    };
    SelectComboMenuOptimized.prototype.inputKeydownEvent = function (event) {
        if (this.accessibility !== 'EDIT') {
            return;
        }
    ...
    SelectComboMenuOptimized.prototype.inputInputEvent2 = function () {
        if (this.accessibility === 'EDIT') {
            this.fireEvent('onInput', this.onInput);
        }
    };
    SelectComboMenuOptimized.prototype.specialKeyCapture = function (fireEvent, event) {
    ...
    SelectComboMenuOptimized.prototype.inputBlurEvent = function () {
        this.closeAutocomplete();
    ...
    SelectComboMenuOptimized.prototype.inputBlurEvent2 = function () {
    ...
    SelectComboMenuOptimized.prototype.update = function (change) {
    ...
    SelectComboMenuOptimized.prototype.updateModel = function () {
        this.rawValue = this.input.value;
        if (this.rawValue === "") {
            this.rawValue = null;
        }
    };
    SelectComboMenuOptimized.prototype.hightlightValue = function () {
        if (this.highlighted == null) {
            return;
        }
    ...
    SelectComboMenuOptimized.prototype.findByValue = function (value) {
        value = value || '';
        for (var _i = 0, _a = this.values; _i < _a.length; _i++) {
            var option = _a[_i];
    ...
    SelectComboMenuOptimized.prototype.findValueByElement = function (value) {
        for (var _i = 0, _a = this.values; _i < _a.length; _i++) {
            var option = _a[_i];
    ...
    SelectComboMenuOptimized.prototype.openAutocomplete = function () {
    ...
    SelectComboMenuOptimized.prototype.closeAutocomplete = function () {
        if (!this.autocompleteOpen)
            return;
    ...
    SelectComboMenuOptimized.prototype.extractChangedAttributes = function () {
    ...
    SelectComboMenuOptimized.prototype.resolveValue = function (value) {
    ...
    SelectComboMenuOptimized.prototype.destroy = function (removeFromParent) {
