...
var TableCellOptimized = /** @class */ (function (_super) {
    __extends(TableCellOptimized, _super);
    function TableCellOptimized(componentObj, parent) {
        var _this = _super.call(this, componentObj, parent) || this;
        _this.componentsToProcess = ["OutputLabel", "InputDate", "SelectComboMenu"];
    ...
    TableCellOptimized.prototype.create = function () {
        var cell = null;
        // @ts-ignore
    ...
    ;
    TableCellOptimized.prototype.addComponents = function (componentsList) {
        (componentsList || []).forEach(function (componentObj) {
            this.addComponent(componentObj);
        }.bind(this));
    };
    ;
    TableCellOptimized.prototype.applyChange = function (change) {
    ...
    ;
    TableCellOptimized.prototype.setAccessibility = function (accessibility) {
     ...
     * @param accessibility
     */
    TableCellOptimized.prototype.display = function () {
        _super.prototype.display.call(this);
        // this.container.appendChild(this.htmlElement);
    };
    TableCellOptimized.prototype.render = function () {
        // //console.log("TableCellOptimized render - do nothing");
    };
    __decorate([
        lazyInject("FH"),
        __metadata("design:type", fh_forms_handler_2.FH)
    ], TableCellOptimized.prototype, "fh", void 0);
    return TableCellOptimized;
}(fh_forms_handler_1.HTMLFormComponent));
exports.TableCellOptimized = TableCellOptimized;
//# sourceMappingURL=TableCellOptimized.js.map