...
var ColumnLazy = /** @class */ (function (_super) {
    __extends(ColumnLazy, _super);
    function ColumnLazy(componentObj, parent) {
    ...
    ColumnLazy.prototype.create = function () {
    ...
    ;
    ColumnLazy.prototype.setSorter = function (parentObject, columnObject, columnElement) {
    ...
    ;
    ColumnLazy.prototype.setSubcolumns = function (parentObject, columnObject, columnElement, currentRow, callback) {
    ...
    ;
    ColumnLazy.prototype.update = function (change) {
    ...
    ;
    ColumnLazy.prototype.getDefaultWidth = function () {
        return null;
    };
    ;
    ColumnLazy.prototype.getAdditionalButtons = function () {
        return [
...
exports.ColumnLazy = ColumnLazy;
//# sourceMappingURL=ColumnLazy.js.map