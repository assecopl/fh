...
class InputTimeFhDP extends InputDateFhDP implements LanguageChangeObserver {

    constructor(componentObj: any, parent: HTMLFormComponent) {
        super(componentObj, parent);

        this.backendFormat = "HH:mm:ss.SSS";
        this.format = this.componentObj.format || 'HH:mm:ss';
        // @ts-ignore
