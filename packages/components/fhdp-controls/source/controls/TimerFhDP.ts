...
class TimerFhDP extends  HTMLFormComponent{
    ...
    constructor(componentObj: any, parent: HTMLFormComponent) {
        ...
        console.log(this.componentObj.timeout, !isNaN(this.componentObj.timeout), Number(this.componentObj.timeout) > 500);
        if (this.componentObj.timeout && !isNaN(this.componentObj.timeout) && Number(this.componentObj.timeout) > 500) {
            this.timeout = Number(this.componentObj.timeout);
