...
<Form xmlns="http://fh.asseco.com/form/1.0" container="mainForm" id="documentationHolder" label="{componentName}">
    ...
    <TabContainer id="_Form_TabContainer">
        <Tab label="{$.fh.docs.component.examples}" id="_Form_TabContainer_Tab1">
            <PanelGroup width="md-12" label="{$.fh.docs.component.mdfileviewer_with_simple_usage}" id="_Form_TabContainer_Tab1_PanelGroup">
                <MdFileViewer id="mdFileViewerExampleCode1_1" src="dokumentacja/wiki/index.md" width="md-12" resourceBasePath="dokumentacja/wiki/"/>
                <Spacer height="25px" width="md-12" id="_Form_TabContainer_Tab1_PanelGroup_Spacer"/>
                <InputText id="inputTextExampleCode1_1" label="{$.fh.docs.component.code}" width="md-12" rowsCount="1">
                    <![CDATA[
                                        <MdFileViewer id="mdFileViewerExampleCode1_1" src="dokumentacja/wiki/index.md" width="md-4" resourceBasePath="dokumentacja/wiki/"/>
                        ]]>
                </InputText>
            </PanelGroup>
        </Tab>
