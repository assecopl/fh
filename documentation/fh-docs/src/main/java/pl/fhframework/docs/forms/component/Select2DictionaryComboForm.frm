...
<Form xmlns="http://fh.asseco.com/form/1.0" container="mainForm" id="documentationHolder" label="{componentName}">
    ...
    <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_static_values}" id="_Form_PanelGroup1">
        ...
        <Select2DictionaryCombo icon="fas fa-search" width="md-12" value="{startValue}" emptyValue="true" label="{$.fh.docs.component.combo_select_user}" provider="pl.fhframework.docs.forms.service.DictionaryComboDataProvider" onChange="-" onInput="-" id="_Form_PanelGroup1_Select2DictionaryCombo">
            <DictionaryComboParameter name="codeListId" value="007" id="_Form_PanelGroup1_Select2DictionaryCombo_Select2DictionaryComboParameter1"/>
            <DictionaryComboParameter name="referenceDate" value="{dataReferencyjna}" id="_Form_PanelGroup1_Select2DictionaryCombo_Select2DictionaryComboParameter2"/>
        </Select2DictionaryCombo>
        <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode6" rowsCount="4">
            <![CDATA[
<Select2DictionaryCombo icon="fas fa-search" value="{startValue}" label="Wybierz uzytkownika" provider="pl.fhframework.docs.forms.service.DictionaryComboDataProvider" onChange="-" onInput="-">
    ...
    <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_static_values}" id="_Form_PanelGroup2">
        ...
        <Select2DictionaryCombo icon="fas fa-search" width="md-12" label="{$.fh.docs.component.combo_select_user}" value="{secondValue}" provider="pl.fhframework.docs.forms.service.DictionaryComboDataProvider" onChange="-" onInput="-" id="_Form_PanelGroup2_Select2DictionaryCombo">

            <DictionaryComboParameter name="codeListId" value="{codeListId}" id="_Form_PanelGroup2_Select2DictionaryCombo_Select2DictionaryComboParameter1"/>
            <DictionaryComboParameter name="referenceDate" value="{dataReferencyjna}" id="_Form_PanelGroup2_Select2DictionaryCombo_Select2DictionaryComboParameter2"/>
        </Select2DictionaryCombo>
        ...
        <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode5" rowsCount="4">
            <![CDATA[
 <Select2DictionaryCombo icon="fas fa-search" width="md-12" label="{$.fh.docs.component.combo_select_user}" provider="pl.fhframework.docs.forms.service.DictionaryComboDataProvider" onChange="-" onInput="-">
