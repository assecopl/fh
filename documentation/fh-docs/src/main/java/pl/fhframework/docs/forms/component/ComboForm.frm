...
<Combo label="Select user" hint="This is example hint" values="Hettie Minks|Karey Ditzler|Malka Garrido|Blanca Quisenberry|Jared Kent|Deborah Lerner|Jerold Mcelroy|Kenton Whitefield|Genna Parker|Madelyn Hanline|Trinity Kelton|Melaine Claassen|Lucilla Scannell|Caryn Vermillion|Erma Soja|Tyree List|Keira Heesch|Rodrigo Erdman|Kellye Chiasson|Marisha Selle" onChange="-" onInput="-"/>
                ...
                <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_static_values_with_collection_as_binding}" id="_Form_TabContainer_Tab1_PanelGroup3">
                    <Combo width="md-12" label="{$.fh.docs.component.combo_select_user}" value="{simpleSelectedCombo}" filterFunction="{userComboFilter}" values="{simpleComboData}" onChange="-" onInput="-" id="_Form_TabContainer_Tab1_PanelGroup3_Combo"/>
                    ...
                    <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode1" rowsCount="4">
                        <![CDATA[
<Combo label="Select user" selectedItem="\{simpleSelectedCombo\}" filterFunction="\{userComboFilter\}" values="\{simpleComboData\}" onChange="-" onInput="-"/>
...
<OutputLabel id="boundComboUserLabel6" width="md-12" value="Typed user was created on : \{simpleSelectedCombo.creationDate\}." />
                ...
                <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_advanced_biding_with_multivaluemap_as_binding}" id="_Form_TabContainer_Tab1_PanelGroup4">
                    <Combo width="md-12" label="{$.fh.docs.component.combo_select_user}" value="{selectedCombo}" filterFunction="{userComboFilter}" values="{comboData}" onChange="-" onInput="-" id="_Form_TabContainer_Tab1_PanelGroup4_Combo"/>
                    ...
                    <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode2" rowsCount="6">
                        <![CDATA[
<Combo label="Select user" selectedItem="\{selectedCombo\}" filterFunction="\{userComboFilter\}" values="\{comboData\}" onChange="-" onInput="-"/>
...
<InputText value="\{selectedCombo\}" onChange="-" id="selectedUserInputText2"/>
                ...
                <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_advanced_biding_with_multivaluemap_as_binding_and_preload_attribute}" id="_Form_TabContainer_Tab1_PanelGroup5">
                    ...
                    <Combo width="md-12" label="{$.fh.docs.component.combo_select_user}" preload="true" value="{selectedCombo}" filterFunction="{userComboFilter}" values="{comboData}" onChange="-" onInput="-" id="_Form_TabContainer_Tab1_PanelGroup5_Combo"/>
                    ...
                    <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode8" rowsCount="2">
                        <![CDATA[![ESCAPE[<Combo label="Select user" preload="true" selectedItem="{selectedCombo}" filterFunction="{userComboFilter}"  values="{comboData}" onChange="-" onInput="-"/>
                 ...
                 <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_static_values_with_collection_as_binding_and_displayFunction}" id="_Form_TabContainer_Tab1_PanelGroup6">
                    <Combo width="md-12" label="{$.fh.docs.component.combo_select_user}" value="{simpleSelectedComboWithDisplayFunction}" displayFunction="{userAsFirstLastNameFunction}" values="{simpleComboData}" onChange="-" onInput="-" id="_Form_TabContainer_Tab1_PanelGroup6_Combo"/>
                    ...
                    <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode1withDisplayFunction1" rowsCount="4">
                        <![CDATA[
<Combo label="Select user" selectedItem="\{simpleSelectedComboWithDisplayFunction\}" displayFunction="\{userAsFirstLastNameFunction\}" values="\{simpleComboData\}" onChange="-" onInput="-"/>
...
<OutputLabel id="boundComboUserLabel9" width="md-12" value="Typed user was created on : \{simpleSelectedComboWithDisplayFunction.creationDate\}." />
                 ...
                 <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_static_values_with_collection_as_binding_and_displayRuleSpel}" id="_Form_TabContainer_Tab1_PanelGroup7">
                    <Combo width="md-12" label="{$.fh.docs.component.combo_select_user}" value="{simpleSelectedComboWithDisplayFunction}" displayRule="firstName+' vel: '+lastName" values="{simpleComboData}" onChange="-" onInput="-" id="_Form_TabContainer_Tab1_PanelGroup7_Combo"/>
                    ...
                    <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode1withDisplayFunction2" rowsCount="4">
                        <![CDATA[
<Combo label="Select user" selectedItem="\{simpleSelectedComboWithDisplayFunction\}" displayExpression="\{firstName+' vel: '+lastName\}" values="\{simpleComboData\}" onChange="-" onInput="-"/>
<OutputLabel id="boundComboUserLabel7" width="md-12" value="Typed user is: \{simpleSelectedComboWithDisplayFunction.firstName\}, \{simpleSelectedComboWithDisplayFunction.lastName\}." />
<OutputLabel id="boundComboUserLabel8" width="md-12" value="Typed user is \{simpleSelectedComboWithDisplayFunction.age\} years old." />
<OutputLabel id="boundComboUserLabel9" width="md-12" value="Typed user was created on : \{simpleSelectedComboWithDisplayFunction.creationDate\}." />
                        ]]>
                ...
                <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_multi_sizes}" id="_Form_TabContainer_Tab1_PanelGroup8">
                    <Combo id="comboCode4_1" label="{$.fh.docs.component.combo_select_user}" values="Hettie Minks|Karey Ditzler|Malka Garrido|Blanca Quisenberry|Jared Kent|Deborah Lerner|Jerold Mcelroy|Kenton Whitefield|Genna Parker|Madelyn Hanline|Trinity Kelton|Melaine Claassen|Lucilla Scannell|Caryn Vermillion|Erma Soja|Tyree List|Keira Heesch|Rodrigo Erdman|Kellye Chiasson|Marisha Selle" onChange="-" onInput="-" width="sm-8,md-4,lg-10"/>
                    <InputText id="comboExampleCode4_2" label="{$.fh.docs.component.code}" width="md-12" rowsCount="3">
                        <![CDATA[
<Combo id="comboCode4_1" label="Select user" values="Hettie Minks|Karey Ditzler|Malka Garrido|Blanca Quisenberry|Jared Kent|Deborah Lerner|Jerold Mcelroy|Kenton Whitefield|Genna Parker|Madelyn Hanline|Trinity Kelton|Melaine Claassen|Lucilla Scannell|Caryn Vermillion|Erma Soja|Tyree List|Keira Heesch|Rodrigo Erdman|Kellye Chiasson|Marisha Selle" onChange="-" onInput="-" width="xs-2,sm-8,md-4,lg-10"/>
                        ]]>
                    </InputText>
                </PanelGroup>

                <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_empty_value}" id="_Form_TabContainer_Tab1_PanelGroup9">
                    <Combo width="md-12" label="{$.fh.docs.component.combo_select_user}" value="{comboUserWithEmptyValue}" filterFunction="{userComboFilter}" values="{comboDataWithEmptyValue}" onChange="-" onInput="-" emptyValue="true" onEmptyValue="-" id="_Form_TabContainer_Tab1_PanelGroup9_Combo"/>
                    ...
                    <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode5" rowsCount="3">
                        <![CDATA[
<Combo label="Select user" selectedItem="\{comboUserWithEmptyValue\}" filterFunction="\{userComboFilter\}" values="\{comboDataWithEmptyValue\}" onChange="-" onInput="-" emptyValue="true" onEmptyValue="-"/>
<OutputLabel id="boundComboUserLabel5_1" width="md-12" value="Selected user is: \{comboUserWithEmptyValue.firstName\} \{comboUserWithEmptyValue.lastName\}." />
            ...
            <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_multiselect}" id="_Form_TabContainer_Tab1_PanelGroup10">
                <Combo width="md-12" label="{$.fh.docs.component.combo_select_users}" value="{selectedUsers}" displayExpression="firstName+' vel: '+lastName" values="{simpleComboData}" onChange="-" onInput="-" multiselect="true" emptyValue="true" onEmptyValue="-" id="_Form_TabContainer_Tab1_PanelGroup10_Combo1"/>
                <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode1withMuliselect" rowsCount="3">
                    <![CDATA[
<Combo label="\{$.fh.docs.component.combo_select_user\}" value="\{selectedUsers\}" displayExpression="firstName+' vel: '+lastName" values="\{simpleComboData\}" onChange="-" onInput="-" multiselect="true" emptyValue="true" onEmptyValue="-"/>
                        ]]>
                </InputText>
                <Combo icon="" width="md-12" label="{$.fh.docs.component.combo_select_users}" value="{selectedUsers}" displayExpression="firstName+' vel: '+lastName" values="{comboData}" onChange="-" onInput="-" multiselect="true" emptyValue="false" onEmptyValue="-" id="_Form_TabContainer_Tab1_PanelGroup10_Combo2"/>
            </PanelGroup>

            <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_enum}" id="_Form_TabContainer_Tab1_PanelGroup11">
                <Combo id="comboWithEnum" width="md-12" label="{$.fh.docs.component.combo_with_enum_pickColor}" values="{enumColors}" emptyValue="true" onEmptyValue="-" onChange="-"/>
                <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode1withEnum" rowsCount="2">
                    <![CDATA[
<Combo label="\{$.fh.docs.component.combo_with_enum_pickColor\}" values="\{enumColors\}" onChange="-" emptyValue="true" onEmptyValue="-"/>
                        ]]>
                </InputText>
            </PanelGroup>

            <PanelGroup width="md-12" label="{$.fh.docs.component.combo_with_enum_and_multiselect}" id="_Form_TabContainer_Tab1_PanelGroup12">
                <Combo id="comboWithEnumAndMultiselect" width="md-12" label="{$.fh.docs.component.combo_with_enum_pickColors}" value="{selectedColors}" values="{enumColors}" emptyValue="true" onEmptyValue="-" onChange="-" multiselect="true"/>
                <InputText width="md-12" label="{$.fh.docs.component.code}" id="comboExampleCode1withEnumAndMultiselect" rowsCount="2">
                    <![CDATA[
<Combo label="\{$.fh.docs.component.combo_with_enum_pickColors\}" value="\{selectedColors\}" values="\{enumColors\}" onChange="-" multiselect="true" emptyValue="true" onEmptyValue="-"/>
                        ]]>
                </InputText>
            </PanelGroup>
        </Tab>
