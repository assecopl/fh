    ...
    template: `
      ...
      <div class="fh-layout-div">
        ...
        <div>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse " id="navbarTogglerDemo03">
                ...
                <div id="navbarForm" class="d-flex">
                  <fh-form [formType]="navbarForm?.formType" [subelements]="navbarForm?.subelements"
                           [id]="navbarForm?.id" [label]="navbarForm?.label" [formId]="navbarForm?.id"
          ...
          <div class="container-fluid">
            <div class="row">
              <div id="menuForm" class="col-sm-12 col-md-3 col-lg-3 col-xl-2 mt-3">
                <fh-form [formType]="menuForm?.formType" [subelements]="menuForm?.subelements" [formId]="menuForm?.id"
                         [id]="menuForm?.id" [label]="menuForm?.label" [hideHeader]="menuForm?.hideHeader"/>
              </div>
              <div id="mainForm" class="col mt-3">
                <fh-form [formType]="mainForm?.formType" [subelements]="mainForm?.subelements" [formId]="mainForm?.id"
                         [id]="mainForm?.id" [label]="mainForm?.label" [hideHeader]="mainForm?.hideHeader"/>
              </div>
            </div>
          </div>
        </div>
