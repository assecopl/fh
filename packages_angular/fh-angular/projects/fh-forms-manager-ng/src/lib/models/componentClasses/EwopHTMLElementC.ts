...
@Directive()
export class EwopHTMLElementC extends EwopComponent implements OnInit, AfterViewInit, AfterContentInit, OnChanges {

  @HostBinding('attr.tabindex')
  public tabindex: number = null;

  // public availabilityDirective: EwopAvailabilityDirective;
  ...
  @Input()
  public hintTrigger: "HOVER" | "FOCUS" | "HOVER FOCUS" | string = 'HOVER FOCUS';
  ...
  // public formatter:EwopFormatter = null;
  public formatter: any = null;
  // public formatterService:EwopFormatterService = null;
  ...
  public override ngOnInit(): void {
    ...
    //   this.formatterService = this.injector.get(EwopFormatterService, null);
