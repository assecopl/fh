import {Host, Injector, Input, Optional, SkipSelf, Directive, SimpleChanges} from '@angular/core';
import {EwopReactiveInputC} from './EwopReactiveInputC';
import {EwopComponent} from "./EwopComponent";
import {IForm} from "@ewop/ng-core";
import {compile, parse, eval as expEval} from 'expression-eval';
...
@Directive()
export class EwopInputWithListC extends EwopReactiveInputC {
    public values: Array<any> = [];
