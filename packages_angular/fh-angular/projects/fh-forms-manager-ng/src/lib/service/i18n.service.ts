...
export class i18nService {
  ...
  public registerStrings(code: string, strings: any, isCustom: boolean = false): void {
    ...
    if (isCustom) {
      this.strings[code] = (<any>Object).assign(this.strings[code] || {}, strings);
    } else {
      this.defaultStrings[code] = (<any>Object).assign(this.defaultStrings[code] || {}, strings);
    }
  }
