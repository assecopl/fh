...
class Util {
    ...
    public showDialog(title: any, message: any, closeButtonLabel: any, closeButtonClass: any, closeCallback: any) {
    ...
    public scrollToComponent(formElementId: string, animateDuration: number | null = null): void {
