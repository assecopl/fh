...
@Component({
  ...
  providers: [
     ...
     */
    {provide: EwopComponent, useExisting: forwardRef(() => DictionaryViewComponent)}
  ]
})
export class DictionaryViewComponent extends OutputLabelComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if ((changes['dictionaryCode'] || changes['parentCode'] || changes['effectiveDate'] || changes['valueSlownik'])) {
  ...
  public getData() {
    if (this.dictionaryProvider && this.dictionaryCode && this.valueSlownik) {
      this.dictionaryProvider.dajWartosc(this.valueSlownik?.kodSlownika, this.valueSlownik?.kodWartosci, this.valueSlownik?.oznaczenieWersji).then(value => {
