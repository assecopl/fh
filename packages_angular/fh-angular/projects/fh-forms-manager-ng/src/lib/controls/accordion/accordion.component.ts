...
@Component({
    ...
    providers: [
         ...
         */
        {provide: EwopComponent, useExisting: forwardRef(() => AccordionComponent)},
        {provide: GroupingComponentC, useExisting: forwardRef(() => AccordionComponent)}
    ]
})
export class AccordionComponent extends GroupingComponentC<PanelGroupComponent> {
    ...
    public subcomponents: QueryList<PanelGroupComponent> = new QueryList<PanelGroupComponent>();
    ...
    public getSubcomponentInstance(): new (...args: any[]) => PanelGroupComponent {
    ...
    public updateSubcomponent = (subcomponent: PanelGroupComponent, index: number) => {
