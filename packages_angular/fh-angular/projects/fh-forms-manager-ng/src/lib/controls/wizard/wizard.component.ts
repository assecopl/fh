...
import {AvailabilityEnum, EwopAvailabilityDirective} from "@ewop/ng-availability";
import {EwopComponent} from "../../models/componentClasses/EwopComponent";


@Component({
    selector: 'ewop-wizard',
    ...
    providers: [
         ...
         */
        {provide: EwopComponent, useExisting: forwardRef(() => WizardComponent)}
    ]
})
export class WizardComponent extends GroupingComponentC<TabComponent> implements OnInit, AfterContentInit {
