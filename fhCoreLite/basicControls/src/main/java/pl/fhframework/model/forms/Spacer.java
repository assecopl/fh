 ...
 * Example <Spacer size="value_1"/>. Every field is parsed as json for javascript. If field
...
@DocumentedComponent(value = "Component used to create spaces in a layout", icon = "fas fa-arrows-alt-h")
