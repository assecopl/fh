...
/**
 * FhServiceConnectionException class. Thrown when there is an runtime error within a UseCase or Rule. FhUseCaseException is direct subclass of a FhException.
 */
@DocumentedClass (description = "FhServiceConnectionException class. Thrown when there is an runtime error within a UseCase or Rule. FhServiceConnectionException is direct subclass of a FhException.")
public class FhServiceConnectionException extends FhMessageException {
    /**
    ...
    public FhServiceConnectionException(String message) {
        super(message);
    }
    ...
    public FhServiceConnectionException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public FhServiceConnectionException(Throwable cause) {
        super(cause);
    }
}
